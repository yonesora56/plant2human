...
- This directory is where you place the indexes used by foldseek (`foldseek databases` and `foldseek createdb` command) and by BLAST (`makeblastdb` command).

&nbsp;

## Component files (version: 2026-03-21)
...
│   ├── afdb_all_sequences_v6.fasta.27.phd
│   ├── afdb_all_sequences_v6.fasta.27.phi
│   ├── afdb_all_sequences_v6.fasta.27.phr
│   ├── afdb_all_sequences_v6.fasta.27.pin
│   ├── afdb_all_sequences_v6.fasta.27.pog
│   ├── afdb_all_sequences_v6.fasta.27.psq
...
├── makeblastdb_error.log
├── makeblastdb.log
├── README.md
└── UP000005640_9606_HUMAN_v6_260320.tar

3 directories, 213 files
```