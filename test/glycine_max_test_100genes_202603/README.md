...
This directory contains the test results for running the plant2human workflow with *Glycine Max* genes.
...
```bash
# test date: 2026-03-24
cwltool --debug --outdir ./test/glycine_max_test_100genes_202603/ \
./Workflow/plant2human_v3_stringent.cwl \
