...
.
├── README.md # This file
├── arabidopsis_100_genes_uniprot_idmapping.ipynb # Step 1 notebook
├── arabidopsis_random_100genes_list.tsv # Input gene list
├── at_100_genes_afinfo_json/ # AlphaFold info JSON files
├── at_100_genes_idmapping_all.tsv # ID mapping results
├── at_100_genes_mmcif/  # Structure files (mmCIF)
├── at_100_genes_plant2human_report_stringent.ipynb  # Final report
...
├── foldseek_at_100genes_9606_stringent.tsv
├── foldseek_hit_species_togoid_convert_stringent.tsv
├── foldseek_output_human_proteome_v6_at_100genes_evalue01_stringent.tsv
...
![image](../../image/at_100_stringent_needle_filter.png)

&nbsp;

## Structural Alignment vs Sequence Alignment (local alignment)

![image](../../image/at_100_stringent_water_filter.png)
